...
<template>
    <div class="m-12">
        <form class="max-w-md mx-auto p-4 bg-gray-900 showdow-md rounded-md" @submit.prevent="storeSkill(form)">
            <div class="space-y-6">
                <div class="mb-6">
                ...
                <div class="mb-6">
                    <label for="slug" class="block mb-2 text-sm font-medium text-black dark:text-white">Slug</label>
